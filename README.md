...
This project demonstrates how to implement and train a reinforcement learning (RL) agent using **Proximal Policy Optimization (PPO)** with the **Stable-Baselines3** library. The agent interacts with environments from **OpenAI Gym**, and results are visualized using **Matplotlib**.
...
- `gym` — Environment interface (e.g., `Env`, `reset()`, `step()`)
- `stable-baselines3` — RL algorithms and training utilities (PPO, DQN, etc.)
